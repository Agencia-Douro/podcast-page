...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "focus:bg-muted hover:text-brown hover:bg-muted focus:text-brown button-14-medium relative flex w-full cursor-default items-center gap-2 py-1.5 pr-8 pl-2 outline-hidden select-none whitespace-nowrap",
        className
      )}
      {...props}
    />
